...
function Library:CreateWindow(title)
	...
	function WindowActions:AddSection(sTitle)
		...
		function SectionActions:AddSlider(text, min, max, default, callback)
			...
			SldFrame.Size = UDim2.new(0.92, 0, 0, 50)
			...
			Bar.Size = UDim2.new(1, -10, 0, 6); Bar.Position = UDim2.new(0, 5, 0, 32); Bar.BackgroundColor3 = Theme.Outline; Instance.new("UICorner", Bar)
