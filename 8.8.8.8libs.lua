...
-- [[ VERSION: V26 RESIZABLE ELEMENTS | AUTHOR: GHOST66266 ]] --
...
Library.Theme = {
	...
	-- [NOUVEAU] CONFIGURATION DES TAILLES
	Sizes = {
		Element = 32,    -- Hauteur des Boutons, Toggles, Dropdowns, Inputs
		Slider = 45,     -- Hauteur des Sliders (généralement plus grands)
...
function Library:CreateWindow(Config)
	...
	function WindowFuncs:AddTab(Name)
		...
		function TabFuncs:AddSection(Title)
			...
			local List = Instance.new("UIListLayout", Container); List.Padding = UDim.new(0, Library.Theme.Sizes.SectionGap) -- [DYNAMIC GAP]
			...
			function SecFuncs:AddButton(Text, Callback)
				local Btn = Instance.new("TextButton", Container); Btn.Size = UDim2.new(1,0,0, Library.Theme.Sizes.Element); -- [DYNAMIC SIZE]
			...
			function SecFuncs:AddToggle(Text, Default, Callback)
				local Tgl = Instance.new("TextButton", Container); Tgl.Size = UDim2.new(1,0,0, Library.Theme.Sizes.Element); -- [DYNAMIC SIZE]
			...
			function SecFuncs:AddSlider(Text, Min, Max, Default, Callback)
				local SldFrame = Instance.new("Frame", Container); SldFrame.Size = UDim2.new(1,0,0, Library.Theme.Sizes.Slider); -- [DYNAMIC SIZE]
			...
			function SecFuncs:AddDropdown(Text, Items, Default, Callback)
				local Drop = Instance.new("Frame", Container); Drop.Size = UDim2.new(1,0,0, Library.Theme.Sizes.Element); -- [DYNAMIC SIZE]
				Drop.BackgroundTransparency = 1; Drop.ClipsDescendants = true
				local Btn = Instance.new("TextButton", Drop); Btn.Size = UDim2.new(1,0,0, Library.Theme.Sizes.Element); -- [DYNAMIC SIZE]
			...
			function SecFuncs:AddTextbox(Text, Callback)
				local BoxFrame = Instance.new("Frame", Container); BoxFrame.Size = UDim2.new(1,0,0, Library.Theme.Sizes.Element); -- [DYNAMIC SIZE]
