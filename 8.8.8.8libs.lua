...
function Library:CreateWindow(Config)
	...
	function WindowFuncs:AddTab(Name)
		local TabBtn = Instance.new("TextButton", TabContainer); TabBtn.Size = UDim2.new(1,0,0, Library.Theme.Sizes.Tab); TabBtn.BackgroundTransparency = 1; TabBtn.Text = ""
		...
		TabLabel.TextSize = Library.Theme.TextSize.Tab; TabLabel.TextXAlignment = Enum.TextXAlignment.Left
		...
		function TabFuncs:AddSection(Title)
			...
			function SecFuncs:AddToggle(Text, Default, Callback)
				local Tgl = Instance.new("TextButton", Container); Tgl.Size = UDim2.new(1,0,0, Library.Theme.Sizes.Element); Tgl.BackgroundTransparency = 1; Tgl.Text = ""; AddClickEffect(Tgl)
				local Lab = Instance.new("TextLabel", Tgl); Lab.Size = UDim2.new(1,-50,1,0); Lab.BackgroundTransparency = 1; Lab.Text = Text; Lab.TextColor3 = Library.Theme.Text; Lab.Font = Enum.Font.GothamMedium; Lab.TextSize = Library.Theme.TextSize.Element; Lab.TextXAlignment = Enum.TextXAlignment.Left
			...
			function SecFuncs:AddSlider(Text, Min, Max, Default, Callback)
				local SldFrame = Instance.new("Frame", Container); SldFrame.Size = UDim2.new(1,0,0, Library.Theme.Sizes.Slider); SldFrame.BackgroundTransparency = 1
				local Lab = Instance.new("TextLabel", SldFrame); Lab.Size = UDim2.new(1,0,0,20); Lab.BackgroundTransparency = 1; Lab.Text = Text; Lab.TextColor3 = Library.Theme.Text; Lab.Font = Enum.Font.GothamMedium; Lab.TextSize = Library.Theme.TextSize.Element; Lab.TextXAlignment = Enum.TextXAlignment.Left
	...
	function WindowFuncs:AddProfile()
		...
		Avatar.Image = "rbxassetid://0"; Avatar.ZIndex = 30
		Instance.new("UICorner", Avatar).CornerRadius = UDim.new(1, 0)
		task.spawn(function()
			local success, content = pcall(function() return Players:GetUserThumbnailAsync(Player.UserId, Enum.ThumbnailType.HeadShot, Enum.ThumbnailSize.Size48x48) end)
			if success then Avatar.Image = content else Avatar.Image = "rbxassetid://16645563" end
		end)

		local DispName = Instance.new("TextLabel", ProfileFrame)
		DispName.Size = UDim2.new(1, -60, 0, 18); DispName.Position = UDim2.new(0, 52, 0, 8); DispName.BackgroundTransparency = 1; DispName.Text = Player.DisplayName or "Player"; DispName.TextColor3 = Color3.fromRGB(255, 255, 255); DispName.Font = Enum.Font.GothamBold; DispName.TextSize = 13; DispName.TextXAlignment = Enum.TextXAlignment.Left; DispName.ZIndex = 30
		local UserName = Instance.new("TextLabel", ProfileFrame)
		UserName.Size = UDim2.new(1, -60, 0, 15); UserName.Position = UDim2.new(0, 52, 0, 26); UserName.BackgroundTransparency = 1; UserName.Text = "@" .. (Player.Name or "Guest"); UserName.TextColor3 = Color3.fromRGB(180, 180, 180); UserName.Font = Enum.Font.Gotham; UserName.TextSize = 11; UserName.TextXAlignment = Enum.TextXAlignment.Left; UserName.ZIndex = 30
	end
